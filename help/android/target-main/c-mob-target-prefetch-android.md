...
>[!IMPORTANT]
>
>A funcionalidade de busca prévia nos sdks móveis para Android não é compatível com tipos de atividades Auto-alvo, Alocação automática e Personalização automatizada no Adobe Target.
