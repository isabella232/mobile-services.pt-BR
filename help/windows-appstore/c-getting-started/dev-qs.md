...
seo-title: Start rápido do desenvolvedor
...
# Start rápido do desenvolvedor {#developer-quick-start}
...
1. No **Solution Explorer**, clique com o botão direito do mouse em **[!UICONTROL Referências]** e selecione **[!UIUCONTROL Adicionar referência]**.
