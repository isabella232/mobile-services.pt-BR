...
* Opção habilitada para carimbo de data e hora
...
As seguintes áreas podem ser acessadas na interface do usuário do Adobe Mobile Services independentemente do conjunto de relatórios pai:
...
* Permita o controle de mensagens no aplicativo/de push, POIs de localização, aquisição e postbacks com todos os dados sendo enviados para um conjunto de relatórios.
   ...
   A equipe regional cria o aplicativo usando o arquivo de configuração do VRS. Os dados são enviados para o conjunto de relatórios principal, mas as mensagens de push/de push, POIs de localização, aquisição e postbacks são controladas no aplicativo que foi criado a partir do VRS.

## Create a virtual report suite in Adobe Analytics {#section_D56B90B2653847D68ECA1F9B39204330}

>[!IMPORTANT]
>
>Somente administradores do Adobe Analytics podem criar e modificar conjuntos de relatórios virtuais no Adobe Analytics. To create a virtual report suite, see [Create virtual report suites](https://docs.adobe.com/content/help/en/analytics/components/virtual-report-suites/vrs-workflow/vrs-create.html).

Cada VRS possui uma ID exclusiva. Para exibir a ID do conjunto de relatórios principal na interface do usuário do Adobe Mobile Services, na página Gerenciar configurações do aplicativo, **[!UICONTROL na seção Informações]** do aplicativo, clique **[!UICONTROL em Mais detalhes]**.
