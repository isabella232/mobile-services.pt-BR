---
description: O processo geral para medição de vídeo é muito parecido em todas as plataformas AppMeasurement. Esta seção fornece uma visão geral básica das tarefas do desenvolvedor junto com amostras de código.
seo-description: O processo geral para medição de vídeo é muito parecido em todas as plataformas AppMeasurement. Esta seção fornece uma visão geral básica das tarefas do desenvolvedor junto com amostras de código.
seo-title: Análise de vídeo
title: Análise de vídeo
uuid: 0 d 2731 f 3-77 a 9-4 db 1-9 a 8 c -1 e 56 c 212 bce 4
...
O processo geral para medição de vídeo é muito parecido em todas as plataformas AppMeasurement. Esta seção fornece uma visão geral básica das tarefas do desenvolvedor junto com amostras de código.

Para obter mais informações sobre a medição de vídeo, consulte [Medição de áudio e vídeo no](https://docs.adobe.com/content/help/en/media-analytics/using/media-overview.html) guia do Adobe Analytics. A tabela a seguir lista os dados de mídia que são enviados para o Analytics. Use as regras de processamento para mapear os dados de contexto na coluna Variável de dados de contexto a uma variável do Analytics, conforme descrito na coluna Tipo de variável.
...
* **a.media.name**
   ...
   **(Opcional)** A variável Insight personalizado fornece informações sobre caminho de vídeo.
...
* **a.media.segment**
   ...
   For example, when a visitor views the first segment in a video, SiteCatalyst might collect `1:M:0-25` in the Segments eVar. O método de coleta de dados de vídeo padrão coleta dados nos pontos de início (play), início do segmento e fim do vídeo (parar).
